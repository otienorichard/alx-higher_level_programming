...
::
    ...
    ... [10.01, 11, 12.3]
    ... ]
    >>> print(matrix_mul(m_a, m_b))    TypeError: m_a should contain only integers or floats
...
Not just any list - they *mustatrices cannot be multiplied (ie. the row count of ``m_a`` is not
