...
shas te:
...	print(te)
lazy_matrix_mul() missing 2 required positional arguments: 'm_a' and 'm_b'pes (2,1) and (2,2) not aligned: 1 (dim 1) != 2 (dim 0)
...
... except Exception as te:
... 	print(te)
Object arrays are not currently sux_mul([[1, 2, 3]], ))
... except Exception as te:
...	print(te)
